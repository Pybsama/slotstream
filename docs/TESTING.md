...
| `Tools/issue21_gate.py` | Chat Completions caps with and without tools, incremental truncated arguments, later-turn reuse when reasoning is omitted, terminal usage and process survival | **yes** | dev Mac, already-running server |
