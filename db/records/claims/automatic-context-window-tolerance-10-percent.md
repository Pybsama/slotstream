...
updated: 2026-09-18T16:12:19.744368+00:00
summary: A larger automatic window may add at most 10% to a typical request
basis: derived
gate: Tools/context_proxy.swift case C23
needle: at most 10%
supported_by: '[[records/measurements/memory-budget-context-policy-2026-09-18]], [[records/measurements/automatic-context-window-plans-2026-09-13]]'
...
## Evidence boundary, 2026-09-18
The tolerance applies only when cache loss is within the measured range. A candidate that removes cache above that range now reports an unmeasured cost and is declined even when the clamped estimate shows no slowdown. Live startup follows the same rule.
