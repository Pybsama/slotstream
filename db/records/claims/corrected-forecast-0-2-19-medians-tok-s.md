...
status: current
---
Medians of decode throughput over the counted cells of each arm (14.38 previous, 15.86 default); they come from different cells, so their quotient is not the paired 1.108.
