...
paths = [root / 'Package.swift', root / 'Package.resolved', root / 'Tools/lib/mlx-0.31.1.metallib']
for base in ['Sources', 'apps/macos/Runtime', 'apps/macos/Presentation', 'apps/macos/App', 'apps/macos/Resources']:
