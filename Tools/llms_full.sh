...
SOURCES=(README.md docs/GETTING-STARTED.md docs/ENGINEERING.md docs/EXPERT-LOOKAHEAD.md docs/HERMES-NOTES.md docs/CLIENTS.md docs/CLI.md docs/API.md docs/LIBRARY.md docs/FX.md docs/HERMES.md docs/CODEX.md docs/TESTING.md \
